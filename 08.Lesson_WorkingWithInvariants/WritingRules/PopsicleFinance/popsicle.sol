...
contract PopsicleFinance is ERC20 {
    ...
    function collectFees() public {
        ...
        uint256 fee_per_share = totalFeesEarnedPerShare -
            accounts[msg.sender].feesCollectedPerShare;
    ...
    function getUserFeesCollectedPerShare(address user)
        public
        view
        returns (uint256)
    {
    ...
    function getTotalFeesEarnedPerShare() public view returns (uint256) {
